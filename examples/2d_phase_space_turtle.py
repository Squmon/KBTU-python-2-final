...
def plot_phase_portrait(trajectories, x_range=(-5,5), y_range=(-5,5), colors=None):
...
def generate_damped_oscillator_trajectories():
    #создаёт траектории для затухающего осциллятора
    trajectories = []
...
if __name__ == "__main__":
    trajectories = generate_damped_oscillator_trajectories()
    plot_phase_portrait(trajectories)
